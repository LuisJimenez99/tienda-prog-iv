...
class AparienciaConfig(models.Model):
    ...
    # --- CAMPOS NUEVOS PARA EL FOOTER ---
    footer_col_contacto_titulo = models.CharField(
        max_length=50, 
        default="Contacto", 
        verbose_name="Título Columna Contacto"
    )
    footer_col_contacto_texto = models.TextField(
        max_length=200, 
        default="¿Tienes una consulta? <br> ¡Escríbeme!", 
        verbose_name="Texto Columna Contacto", 
        blank=True
    )
    footer_link_instagram = models.URLField(
        max_length=255, 
        blank=True, null=True, 
        verbose_name="Enlace Instagram", 
        help_text="URL completa (ej: https://instagram.com/...)"
    )
    footer_link_whatsapp = models.URLField(
        max_length=255, 
        blank=True, null=True, 
        verbose_name="Enlace WhatsApp", 
        help_text="URL completa (ej: https://wa.me/123456...)"
    )
    footer_texto_creditos = models.CharField(
        max_length=100, 
        default="Luis Jiménez", 
        verbose_name="Nombre Creador (Footer)"
    )
...
class Servicio(models.Model):
    """
    Representa un plan o servicio editable desde el admin,
    como "Consulta Nutricional" o "Acceso al Recetario".
    """
    ...
    tipo_servicio = models.CharField(
        ...
        default='TURNO',
        verbose_name="Tipo de Botón",
        help_text="Esto define qué hace el botón 'Contratar': enlazar al calendario o generar un pago."
    )
    
    icono = models.CharField(
        max_length=50, 
        blank=True, null=True, 
        verbose_name="Icono (Clase de Font Awesome)", 
        help_text="Opcional. Ej: 'fas fa-calendar-alt' o 'fas fa-book-open'"
    )
    ...
    activo = models.BooleanField(
        default=True, 
        verbose_name="¿Mostrar este servicio en la página?"
    )
